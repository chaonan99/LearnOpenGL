...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3fv(glGetUniformLocation(screenShader.Program, "viewPos"), 1, &camera.Position[0]);
		glUniform1f(glGetUniformLocation(screenShader.Program, "height_scale"), 0.1);
		glUniform1i(glGetUniformLocation(screenShader.Program, "diffuseTexture"), 0);
		glUniform1i(glGetUniformLocation(screenShader.Program, "normalMap"), 1);
		glUniform1i(glGetUniformLocation(screenShader.Program, "depthMap"), 2);
