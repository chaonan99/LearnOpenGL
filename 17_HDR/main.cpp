...
int main()
{
	...
	Shader lightShader("screenVertex.glsl", "lightFragment.glsl");
	Shader blurShader("hdrVertex.glsl", "blurFragment.glsl");
	...
	// Load textures
	woodTexture = loadTexture("../Public/wood.png");
	containerTexture = loadTexture("../Public/container2.png");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		{
			glUniform3fv(glGetUniformLocation(screenShader.Program,
		...
		glUniform1i(glGetUniformLocation(screenShader.Program, "inverse_normals"), GL_FALSE);
