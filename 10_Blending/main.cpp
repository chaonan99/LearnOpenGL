...
int main()
{
	...
	Shader shader("vertex_depth.glsl", "fragment_depth.glsl");
	Shader shaderSingleColor("vertex_depth.glsl", "fragment_single_color.glsl");
...
#pragma region "object_initialization"
	...
	// Load textures
	GLuint cubeTexture = loadTexture("../Public/window.png");
	GLuint floorTexture = loadTexture("../Public/metal.png");
	GLuint grassTexture = loadTexture("../Public/grass.png");
#pragma endregion
